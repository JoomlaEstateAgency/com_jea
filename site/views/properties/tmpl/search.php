...
<form action="<?php echo JRoute::_('index.php?option=com_jea&task=properties.search') ?>" method="post" id="jea-search-form">
	...
	<div class="jea-counter">
		<span class="jea-counter-result">0</span> <?php echo JText::_('COM_JEA_FOUND_PROPERTIES')?>
	</div>
	<?php endif ?>
	...
	<dl class="col-left">
		<dt>
			<label for="jea-search-budget-min"><?php echo JText::_('COM_JEA_MIN') ?> : </label>
		</dt>
		<dd>
			<input id="jea-search-budget-min" type="text" name="filter_budget_min" size="5" value="<?php echo $states['filter_budget_min'] ?>" />
			<?php echo $this->params->get('currency_symbol', '&euro;') ?>
		</dd>
	</dl>
	<dl class="col-right">
		<dt>
			<label for="jea-search-budget-max"><?php echo JText::_('COM_JEA_MAX') ?> : </label>
		</dt>
		<dd>
			<input id="jea-search-budget-max" type="text" name="filter_budget_max" size="5" value="<?php echo $states['filter_budget_max'] ?>" />
			<?php echo $this->params->get('currency_symbol', '&euro;') ?>
		</dd>
	</dl>
	<?php endif ?>
	...
	<dl class="col-left">
		<dt>
			<label for="jea-search-living-space-min"><?php echo JText::_('COM_JEA_MIN') ?> : </label>
		</dt>
		<dd>
			<input id="jea-search-living-space-min" type="text" name="filter_living_space_min" size="5"
	...
	<dl class="col-right">
		<dt>
			<label for="jea-search-living-space-max"><?php echo JText::_('COM_JEA_MAX') ?> : </label>
		</dt>
		<dd>
			<input id="jea-search-living-space-max" type="text" name="filter_living_space_max" size="5"
	...
	<dl class="col-left">
		<dt>
			<label for="jea-search-land-space-min"><?php echo JText::_('COM_JEA_MIN') ?> : </label>
		</dt>
		<dd>
	...
	<ul class="jea-search-other">
		...
		<li>
			...
			<input id="jea-search-rooms" type="text" name="filter_rooms_min" size="2" value="<?php echo $states['filter_rooms_min'] ?>" />
		</li>
		<?php endif?>
		...
		<li>
			...
			<input id="jea-search-bedrooms" type="text" name="filter_bedrooms_min" size="2" value="<?php echo $states['filter_bedrooms_min'] ?>" />
		</li>
		<?php endif?>
		...
		<li>
			...
			<input id="jea-search-bathrooms" type="text" name="filter_bathrooms_min" size="2" value="<?php echo $states['filter_bathrooms_min'] ?>" />
		</li>
		<?php endif?>
