...
<?php if ($states['filter_transaction_type'] == 'RENTING'): ?>
  <strong><?php echo Text::_('COM_JEA_OPTION_RENTING') ?></strong>
<?php elseif ($states['filter_transaction_type'] == 'SELLING'): ?>
  <strong><?php echo Text::_('COM_JEA_OPTION_SELLING') ?></strong>
<?php endif ?>

<?php if ($states['filter_type_id'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_PROPERTY_TYPE_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_type_id'], 'types') ?>
<?php endif ?>

<?php if ($states['filter_department_id'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_DEPARTMENT_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_department_id'], 'departments') ?>
<?php endif ?>

<?php if ($states['filter_town_id'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_TOWN_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_town_id'], 'towns') ?>
<?php endif ?>

<?php if ($states['filter_area_id'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_AREA_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_area_id'], 'areas') ?>
<?php endif ?>

<?php if (!empty($states['filter_zip_codes'])): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_ZIP_CODE_LABEL') ?> : </strong>
    <?php echo $this->escape($states['filter_zip_codes']) ?>
<?php endif ?>

<?php if ($states['filter_budget_min'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_BUDGET_MIN') ?> : </strong>
    <?php echo HTMLHelper::_('utility.formatPrice', $states['filter_budget_min']) ?>
<?php endif ?>

<?php if ($states['filter_budget_max'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_BUDGET_MAX') ?> : </strong>
    <?php echo HTMLHelper::_('utility.formatPrice', $states['filter_budget_max']) ?>
<?php endif ?>

<?php if ($states['filter_living_space_min'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_LIVING_SPACE_MIN') ?> : </strong>
    <?php echo HTMLHelper::_('utility.formatSurface', $states['filter_living_space_min']) ?>
<?php endif ?>

<?php if ($states['filter_living_space_max'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_LIVING_SPACE_MAX') ?> : </strong>
    <?php echo HTMLHelper::_('utility.formatSurface', $states['filter_living_space_max']) ?>
<?php endif ?>

<?php if ($states['filter_land_space_min'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_LAND_SPACE_MIN') ?> : </strong>
    <?php echo HTMLHelper::_('utility.formatSurface', $states['filter_land_space_min']) ?>
<?php endif ?>

<?php if ($states['filter_land_space_max'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_LAND_SPACE_MAX') ?> : </strong>
    <?php echo HTMLHelper::_('utility.formatSurface', $states['filter_land_space_max']) ?>
<?php endif ?>

<?php if ($states['filter_rooms_min'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_NUMBER_OF_ROOMS_MIN') ?> : </strong>
    <?php echo $this->escape($states['filter_rooms_min']) ?>
<?php endif ?>

<?php if ($states['filter_bedrooms_min'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_NUMBER_OF_BEDROOMS_MIN') ?> : </strong>
    <?php echo $this->escape($states['filter_bedrooms_min']) ?>
<?php endif ?>

<?php if ($states['filter_bathrooms_min'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_NUMBER_OF_BATHROOMS_MIN') ?> : </strong>
    <?php echo $this->escape($states['filter_bathrooms_min']) ?>
<?php endif ?>

<?php if ($states['filter_floor'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_FLOOR_LABEL') ?> : </strong>
    <?php echo $this->escape($states['filter_floor']) ?>
<?php endif ?>

<?php if ($states['filter_hotwatertype'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_HOTWATERTYPE_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_hotwatertype'], 'hotwatertypes') ?>
<?php endif ?>

<?php if ($states['filter_heatingtype'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_HEATINGTYPE_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_heatingtype'], 'heatingtypes') ?>
<?php endif ?>

<?php if ($states['filter_condition'] > 0): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_CONDITION_LABEL') ?> : </strong>
    <?php echo $this->getFeatureValue($states['filter_condition'], 'conditions') ?>
<?php endif ?>

<?php if (!empty($states['filter_orientation'])): ?>
  <br/>
  <strong><?php echo Text::_('COM_JEA_FIELD_ORIENTATION_LABEL') ?> : </strong>
    <?php
...
<?php if (is_array($states['filter_amenities']) && !empty($states['filter_amenities'])): ?>
  ...
  <strong><?php echo Text::_('COM_JEA_AMENITIES') ?> : </strong>
    <?php echo HTMLHelper::_('amenities.bindList', $states['filter_amenities']) ?>
<?php endif ?>
