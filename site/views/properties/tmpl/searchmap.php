...
HTMLHelper::script('com_jea/geoxml3.js', array('relative' => true));
HTMLHelper::script('com_jea/jquery-geoSearch.js', array('relative' => true));
HTMLHelper::script('com_jea/jquery-ui-draggable.min.js', array('relative' => true));
HTMLHelper::script('com_jea/jquery-biSlider.js', array('relative' => true));
...
<form action="<?php echo Route::_('index.php?option=com_jea&view=properties&task=properties.search&Itemid=' . $this->itemId) ?>"
  ...
  <p>
    ...
    <span id="found_properties"><?php echo Text::_('COM_JEA_FOUND_PROPERTIES') ?> : <span
          id="properties_count">0</span></span>
  </p>

  <div id="map_canvas"
       style="width: <?php echo $map_width ? $map_width . 'px' : '100%' ?>; height: <?php echo $map_height . 'px' ?>"></div>
  ...
  <div class="clr"></div>
    ...
    <?php if ($this->params->get('searchform_show_number_of_rooms', 1)): ?>
      <p>
          <?php echo Text::_('COM_JEA_NUMBER_OF_ROOMS_MIN') ?>:
  ...
  <p>
    ...
    <input type="submit" class="button" value="<?php echo Text::_('COM_JEA_LIST_PROPERTIES') ?>"/>
  </p>
</form>
