...
<form action="<?php echo JRoute::_('index.php?option=com_jea&task=default.sendContactForm') ?>" method="post" id="jea-contact-form">
	<fieldset>
		<legend><?php echo JText::_('COM_JEA_CONTACT_FORM_LEGEND') ?></legend>
		<dl>
			<dt>
				<label for="name"><?php echo JText::_('COM_JEA_NAME') ?> :</label>
			</dt>
			...
			<dt>
				<label for="email"><?php echo JText::_('COM_JEA_EMAIL') ?> :</label>
			</dt>
			...
			<dt>
				<label for="telephone"><?php echo JText::_('COM_JEA_TELEPHONE') ?> :</label>
			</dt>
			...
			<dt>
				<label for="subject"><?php echo JText::_('COM_JEA_SUBJECT') ?> :</label>
			</dt>

			<dd>
				<input type="text" name="subject" id="subject" size="30"
				value="<?php echo JText::_('COM_JEA_REF') ?> : <?php echo $this->escape($this->row->ref) ?>" />
			</dd>

			<dt>
				<label for="e_message"><?php echo JText::_('COM_JEA_MESSAGE') ?> :</label>
			</dt>
